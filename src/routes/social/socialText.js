...
jobs_body1.setText(english, "Those who have applied for or received a residence permit are allowed to work in Germany. Links to job boards \
                                (https://de.indeed.com/jobs (not specific for refugees), https://www.jobs4refugees.org/, https://workeer.de/, \
                                https://hr-integrate.com/index.php?lang=en, https://www.arbeitsagentur.de/).");
...
jobs_body2.setText(english, "All German employees have rights while working in the country. Information about these rights and resources to \
                                resolve labor-related issues can be found on w2eu.info (English, Arabic, Persian, French).");
...
asylum_body1.setText(english, "Resources for those still seeking asylum in Europe . Other sources of information can be found on w2eu.info or via ");
export let asylum_link = new Dictionary();
asylum_link.setText(english, "the ELENA index.");
...
edu_body1.setText(english, " (from Pro Asyl) contains locations of German Universities that offer ways for refugees to learn or study, \
                                ...
                                collected on sites such as Hochschulforum Digitalisierung and https://www.oncampus.de/.");
...
edu_link3.setText(english, "https://www.oncampus.de/");
...
integration_body1.setText(english, "Information about integration courses in Germany can be found on the BAMF website in multiple languages. Integration courses often include courses about language, history, and culture.");
export let integration_link = new Dictionary();
integration_link.setText(english, "BAMF");
